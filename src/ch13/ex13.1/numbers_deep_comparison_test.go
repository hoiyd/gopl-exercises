...
func Example_equal() {
	...
	// For comparison bewteen two numbers, regardless of their types,
	// if they differ by less than one part in a billion, they are treated equal.
	var a, b, c float64 = 1000000000, 999999999, 999999998
